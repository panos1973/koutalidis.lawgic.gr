...
import { DocumentCreationFile } from '@/lib/types/types'
...
const FileManagerModal: NextPage<Props> = ({ documentCreationId, files }) => {
  return (
    <div>
      <Dialog>
        ...
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Manage Your Document Files</DialogTitle>
            <DialogDescription>
              This where you can manage your document files.
            </DialogDescription>
          </DialogHeader>
          {/* <UploadFile documentCreationId={documentCreationId} /> */}
          <div className="mt-">
