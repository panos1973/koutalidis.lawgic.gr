...
import { DocumentCreationFile, UsageLimitsWithCheck } from '@/lib/types/types'
...
import { deleteDocumentCreationFile } from '@/app/[locale]/actions/document_creation_actions'
...
const ResourcesManager: NextPage<Props> = ({
  ...
  const [openFile, setOpenFile] = useState<DocumentCreationFile | null>(null)
