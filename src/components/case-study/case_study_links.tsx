...
const CaseStudyLinks: NextPage<Props> = ({
  ...
  const handleCaseStudySelection = (caseStudyId: string) => {
  ...
  const renderCaseStudyContent = (caseStudy: CaseStudy) => (
    <TooltipProvider>
      <Tooltip>
  ...
  const renderNoteEditingContent = (caseStudy: CaseStudy) => (
    <TooltipProvider>
      <Tooltip>
        <TooltipTrigger asChild>
          <div className="min-w-1/2">
            ...
            <input
              ...
              value={notes[caseStudy.id] || caseStudy.note || ''}
              onChange={(e) =>
                setNotes((prevNotes) => ({
                  ...prevNotes,
                    ...
                    className={cn(
                      'py-3 hover:cursor-pointer px-2 flex flex-col justify-center items-center',
                      {
                        ...
                        'bg-red-100 border-l-4 border-red-500':
                          isMassDelete &&
                          selectedCaseStudies.includes(caseStudy.id),
                      }
                    )}
                    key={caseStudy.id}
                  >
                      ...
                      {visibleNoteCaseStudyId === caseStudy.id ? (
                        ...
                        >
                          <div className="w-full">
                            {renderNoteEditingContent(caseStudy)}
                          </div>
                        </Link>
                      ) : isMassDelete ? (
                        <div
                          className="w-full cursor-pointer"
                          onClick={() => handleCaseStudySelection(caseStudy.id)}
                        >
                          <div className="w-full">
          ...
          <div
            className={cn(
              'py-3 hover:cursor-pointer px-2 flex flex-col justify-center items-center',
              {
                ...
                'bg-red-100 border-l-4 border-red-500':
                  isMassDelete && selectedCaseStudies.includes(caseStudy.id),
              }
            )}
            key={caseStudy.id}
          >
